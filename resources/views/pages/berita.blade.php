...
@section('title', 'Desa Ngloram | Berita')
            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        @foreach ($berita as $item)
                            <div class="post-item">
                                ...
                                <div class="post-content">
                                    <ul class="post-meta">
                                        <li>
                                            <a href="{{ route('berita.show', $item->slug) }}"><i
                                    ...
                                    <a href="{{ route('berita.show', $item->slug) }}" class="post-link">Read More <i
                    ...
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $berita->previousPageUrl() }}" rel="prev"><i
                        ...
                        @if ($currentPage > $range + 1)
                            <li class="page-item"><a class="page-link" href="{{ $berita->url(1) }}">1</a></li>
                        ...
                        @for ($page = max(1, $currentPage - $range); $page <= min($lastPage, $currentPage + $range); $page++)
                            ...
                            @else
                                <li class="page-item"><a class="page-link"
                                        href="{{ $berita->url($page) }}">{{ $page }}</a></li>
                            @endif
                        @endfor
                        ...
                        @if ($currentPage < $lastPage - $range)
                            ...
                            @endif
                            <li class="page-item"><a class="page-link"
                                    href="{{ $berita->url($lastPage) }}">{{ $lastPage }}</a></li>
                        @endif

                        {{-- Next Page Link --}}
                        @if ($berita->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $berita->nextPageUrl() }}" rel="next"><i
