...
@section('title', 'Desa Ngloram | Pengumuman')
            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        @foreach ($pengumuman as $item)
                            <div class="post-item">
                                ...
                                <div class="post-content">
                                    <ul class="post-meta">
                                        <li>
                                            <a href="{{ route('pengumuman.show', $item->slug) }}"><i
                                    ...
                                    <a href="{{ route('pengumuman.show', $item->slug) }}" class="post-link">Read More <i
                    ...
                    <ul class="pagination">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $pengumuman->previousPageUrl() }}" rel="prev"><i
                        ...
                        @if ($currentPage > $range + 1)
                            <li class="page-item"><a class="page-link" href="{{ $pengumuman->url(1) }}">1</a></li>
                        ...
                        @for ($page = max(1, $currentPage - $range); $page <= min($lastPage, $currentPage + $range); $page++)
                            ...
                            @else
                                <li class="page-item"><a class="page-link"
                                        href="{{ $pengumuman->url($page) }}">{{ $page }}</a></li>
                            @endif
                        @endfor
                        ...
                        @if ($currentPage < $lastPage - $range)
                            ...
                            @endif
                            <li class="page-item"><a class="page-link"
                                    href="{{ $pengumuman->url($lastPage) }}">{{ $lastPage }}</a></li>
                        @endif

                        {{-- Next Page Link --}}
                        @if ($pengumuman->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $pengumuman->nextPageUrl() }}" rel="next"><i
